...
| Data-page EDA inputs | `eda_inputs/integrated_monthly_base.parquet`, `eda_inputs/feature_table.parquet`, `eda_inputs/imputation_log.parquet` | Small source/feature snapshots for public source-series EDA, correlation notes, predictive screening, and missing-data reporting. |
